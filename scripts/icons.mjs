#!/usr/bin/env node
// Bake icon paths + seller names for every app in apps.js into icons.json.
...
writeFileSync(join(root, 'icons.json'), JSON.stringify({ base: BASE, suffix: SUFFIX, icons, sellers }, null, 0) + '\n');
